...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (userInfoForm) {
        userInfoForm.addEventListener('submit', function(event) {
            ...
            window.location.href = "../RD_texting/templates/RD_texting/campaign.html";
        });
    }
    ...
    if (window.location.pathname.includes('/main/contact/') || window.location.pathname.endsWith('/contact.html')) {
        ...
        // Function to change color of stars
        ...
        submitFeedbackButton.addEventListener("click", function() {
            if (feedbackText.value.trim() !== "" && selectedStarValue > 0) {
                ...
                highlightStars(0); // Reset star highlighting
                selectedStarValue = 0; // Reset selected star value
            } else {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (submitLocationButton) {  // Check if the button exists
        submitLocationButton.addEventListener('click', function() {
    ...
    let ageSelectionContainer = document.getElementById('ageSelectionContainer');
    if (ageSelectionContainer) {
        ageSelectionContainer.addEventListener('change', function() {
    ...
    audienceSizeSubmitButton.addEventListener('click', function() {
        ...
        if (audienceSize.length === 1) {
            // Hide the audience size container
            audienceSizeContainer.style.display = 'none';
    ...
    document.getElementById("frequencySubmit").addEventListener("click", function() {
        const selectedFrequency = getSelectedValues('frequency');
        if (selectedFrequency.length === 1) {
            ...
            // Translate the frequency value to human-readable text
            ...
            const frequencyText = frequencyTextMapping[selectedFrequency[0]];
    
            summary.innerHTML = `
                Locations: ${locations.join(', ')}<br>
                Cities: ${selectedCities.join(', ')}<br>
                Age Groups: ${ages.join(', ')}<br>
                Audience Size: ${audienceSize[0]}<br>
...
// For submitAd - this code block will only run if submitAd exists on the page
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        form.addEventListener("submit", function(event) {
            ...
            // If form fields are valid, submit the form and redirect to campaign.html
            // This assumes you're not sending the form data to a server. 
            // If you are, you'd handle that logic here.
            window.location.href = "/main/campaign/";
        });
    });
